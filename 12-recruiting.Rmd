...
It is necessary to first make contact with the head teacher (or sometimes a designated community liaison) of a school and explain 1) what your study entails for the participants, and 2) what we anticipate learning from it. The head teacher can authorize us to send consent forms for parents home with children, and make a quiet place in the school available for testing. 
...
Often, it is necessary to test children in a controlled setting. We use the CUCHDS facilities for this. CUCHDS features several child-friendly testing spaces, including some equipped with EEG, fNIRS, and eye-tracking capabilites, bookable by personnel with access. (The PI can request access on your behalf.)
