...
\textbf{\emph{Postgraduate Researchers}} (PGRs) are undertaking lab work as part of their preparation of a postgraduate thesis. PGRs are usually PhD students working for 3 years, or maybe 1 + 3 years if their funding also includes a year of MSc study. PGRs' main priority is completing a coherent body of research for their thesis. All of the research they undertake for that project could end up being published on its own, but pieces could also be integrated into other lab projects. This is one reason cross-project continuity is important. PGRs will usually move on to a research job elsewhere once their education is complete. At that point, research they carried out that hasn't been published yet may not be their top priority, and the PI and post-docs can be helpful in ensuring that unfinished strands of work continue to flourish.
...
\item
  Whenever a lab member moves on from the lab, every project s/he led must be documented and made accessible to the PI on \textbf{\emph{OSF}} (for Open Science Framework; osf.io). At the point, if the project is not published, the PI must be given full editing authority along with the former lab member.
\end{enumerate}
...
Kayleigh Hughes, PhD student

Nuno Sobrinho, visiting PhD student from the University of Porto

\subsection{UGRs}\label{ugrs}

Libby Howell-Jones, UG placement student

Summer Cox (UGR project)

Hanna Lewis (UGR project)

Mariya Kanevska (UGR project)

Scott McConnachie (UGR project)

Yilmaz Ozyahyalar (UGR project)

Rebecca Underwood (UGR project)

\section{School of Psychology staff who support us}\label{school-of-psychology-staff-who-support-us}

\begin{itemize}
\item
  IT services (\href{mailto:it-servicedesk@cardiff.ac.uk}{\nolinkurl{it-servicedesk@cardiff.ac.uk}}) help with computing equipment needs.
\item
  Research administrators (\href{mailto:psych-research-admin@cardiff.ac.uk}{\nolinkurl{psych-research-admin@cardiff.ac.uk}}) help with putting together and submitting grant applications.
\item
  Open Access administrators need to know when a paper has been accepted for publication, and can help facilitate making it OA and paying OA journal fees (\href{mailto:Psych-OpenAccess@cardiff.ac.uk}{\nolinkurl{Psych-OpenAccess@cardiff.ac.uk}})
\end{itemize}

\section{Local collabortors and academics interested in memory or related things}\label{local-collabortors-and-academics-interested-in-memory-or-related-things}

\href{https://www.cardiff.ac.uk/people/view/133632-chambers-chris}{Prof.~Chris Chambers}

\href{http://psych.cf.ac.uk/contactsandpeople/evanslh.php}{Dr.~Lisa Evans}

\href{https://www.cardiff.ac.uk/people/view/2470753-}{Dr.~David Greeno}

\href{https://www.cardiff.ac.uk/people/view/2670796-}{Dr.~Dominic Guitard}

\href{http://psych.cf.ac.uk/contactsandpeople/morganphil.php}{Dr.~Phil Morgan}

\href{http://psych.cf.ac.uk/contactsandpeople/moreyr.php}{Dr.~Richard Morey}

\href{https://profiles.cardiff.ac.uk/staff/nikolovty}{Dr.~Teodor Nikolov}

\section{Current and recent international collaborators}\label{current-and-recent-international-collaborators}

\href{https://www.boystownhospital.org/research/Faculty/Pages/Angela-AuBuchon.aspx}{Dr.~Angela AuBuchon, Boys Town National Research Hospital}

\href{https://www.ed.ac.uk/profile/bonnie-auyeung}{Dr.~Bonnie Auyeung, University of Edinburgh}

\href{https://www.ed.ac.uk/profile/nicolas-chevalier}{Dr.~Nic Chevalier, University of Edinburgh}

\href{http://memory.psych.missouri.edu/cowan.shtml}{Prof.~Nelson Cowan, University of Missouri}

\href{https://www.lsu.edu/hss/psychology/faculty/cognitive/elliott.php}{Prof.~Emily Elliott, Louisiana State University}

\href{https://www.cardiffmet.ac.uk/health/staff/Pages/Helen-Hodgetts.aspx}{Dr.~Helen Hodgetts, Cardiff Metropolitan University}

\href{https://psy.rptu.de/en/wus/cognition-and-development-lab/team/prof-julia-karbach}{Prof.~Julia Karbach, University of Koblenz-Landau}

\href{https://psychlabs.colostate.edu/camlab/people/}{Dr.~Vanessa Loaiza, Colorado State University}

\href{https://www.strath.ac.uk/staff/brownlouisedr/}{Prof.~Louise Brown Nicholls, University of Strathclyde}

\href{https://www.researchgate.net/profile/Hanane-Ramzaoui}{Dr.~Hanane Ramzaoui, Louisiana State University}

\href{https://www.linkedin.com/in/marleneroesner/}{Dr.~Marlene Rösner, Otto von Guericke Universität Magdeburg}

\href{https://sigarra.up.pt/fpceup/en/func_geral.formview?p_codigo=654770}{Dr.~Alessandra Souza, University of Porto}

\href{https://www.unige.ch/fapse/womcogdev/home/contact/evie-vergauwe}{Dr.~Evie Vergauwe, University of Geneva}

\section{Alumni}\label{alumni}

\href{https://profiles.cardiff.ac.uk/staff/greenodj}{Dr.~David Greeno (ESRC Fellow)}

Dr.~Tanya Joseph (PDRA)

\href{https://www.linkedin.com/in/molly-a-delooze-68518428a/}{Dr.~Molly Delooze}

\href{https://www.slu.edu/medicine/ahead/about-us/ahead-team/jason-doherty.php}{Dr Jason Doherty (PGR co-supervisee, University of Edinburgh)}

\href{https://www.researchgate.net/profile/Jaroslaw-Lelonkiewicz}{Dr.~Jaroslaw Lelonkiewcisz (PGR, University of Edinburgh)}

\href{https://www.linkedin.com/in/drjonathanmall/}{Dr.~Jonathan Mall (PGR supervisee, Rijksuniversiteit Groningen)}

\href{https://profiles.cardiff.ac.uk/staff/nikolovty}{Dr.~Teodor Nikolov (PGR supervisee, Cardiff University)}

\href{https://linkedin.com/in/aoife-o-mahony-913769a1}{Dr.~Aoife O'Mahoney (PGR co-supervisee, Cardiff University)}

\href{https://www.lernpraxis.ch/team/clara-overkott/}{Dr.~Clara Overkott (Visiting PhD student, University of Zurich)}

\href{https://nyuad.nyu.edu/en/research/faculty-labs-and-projects/fougnie-lab/edyta-sasin.html}{Dr.~Edyta Sasin (PGR co-supervisee, Rijksuniversiteit Groningen)}

\href{https://www.floriansense.com/}{Dr.~Florian Sense (PGR co-supervisee \& UGR project, Rijksuniversiteit Groningen)}
...
Yuhao He (MSc rotation, Cardiff University)
...
\href{https://mphiliastides.org/en/team/ralitsa-kostova}{Ralitsa Kostova (RA, Cardiff University)}

Monica Miron (MSc project, University of Edinburgh)

Lewis Montgomery (MSc project, University of Edinburgh)

\href{https://www.rug.nl/staff/r.nijenkamp/}{Dr.~Rob Nijenkamp (MSc project, Rijksuniversiteit Groningen)}

Marina Nikoletsopoulou (MSc project, University of Edinburgh)

Pamela Paniccia (MSc student, Cardiff University)
...
Samia Ali (UGR project, Cardiff University)

Amy Andrews (UGR, University of Edinburgh)

Emily Barbour (UGR project, Cardiff University)
...
\href{https://www.linkedin.com/in/maltebieler/}{Dr.~Malte Bieler (UGR project, Rijksuniversiteit Groningen)}
...
Elan Gwilym (UGR project, Cardiff University)

Amy Hamlyn (UGR project, Cardiff University)

Molly Horne (UGR project, Cardiff University)

Christian Hummeluhr (UGR, Rijksuniversiteit Groningen)

Lydia Jones (UGR project, Cardiff University)

Nia Jones (UG intern, Cardiff University)

Harleen Kaur (UGR project, Cardiff University)
...
\href{https://experts.exeter.ac.uk/40393-silvana-mareva}{Dr.~Silvana Mareva (UGR, University of Edinburgh)}
...
\href{https://www.linkedin.com/in/antoniasudkaemper/}{Dr.~Antonia Südkamper (UGR intern, Rijksuniversiteit Groningen)}

Peter Thomas (UGR project, Cardiff University)

Abigail White (UGR project, Cardiff University)

Emily Wiegold (UGR project, Cardiff University)

Charlotte Williams (UG intern, visiting Cardiff University from Plymouth University)

Harrison Wilson (UG intern, Cardiff University)

\href{https://www.esi-frankfurt.de/people/michaelwolff/}{Dr.~Michael J. Wolff (UGR project, Rijksuniversiteit Groningen)}
...
\section{Choosing a research question}\label{choosing-a-research-question}
...
\def\labelenumi{\arabic{enumi}.}
\item
  Try to think of a design that can offer you more than one way to address your point.
\item
...
\section{Planning for converging evidence}\label{planning-for-converging-evidence}
...
\section{Illustrations of scope and output of student projects}\label{illustrations-of-scope-and-output-of-student-projects}
...
\subsection{Holotype: UG dissertation timeline and workload}\label{holotype-ug-dissertation-timeline-and-workload}
...
\tightlist
\item
  Written an experimental protocol explaining step-by-step \emph{how} to run a session
\item
  Tested at least one pilot participant to make sure your protocol includes every step needed
\item
  Gone over the output from your program with one of the senior researchers to make sure it records everything you need to answer your research questions
\item
  Scheduled a real participant for a time when one of the senior researchers in the lab can supervise and check that your implementation of the protocol is fine
\item
  Created an Open Science Framework page for your experiment (with the PI as a full-fledged user), uploaded your experimental software, your protocol, paperwork, and a written description of your method and planned analyses
\end{enumerate}
...
\subsection{Holotype: PhD thesis timeline and workload}\label{holotype-phd-thesis-timeline-and-workload}
...
\section{Making the most of your time}\label{making-the-most-of-your-time}
...
\section{Workload expectations}\label{workload-expectations}
...
\chapter{Lab meetings and communication}\label{lab-meetings-and-communication}
...
\tightlist
\item
  Logistics: Is anything broken? Are there scheduling conflicts/difficulties? Programs to troubleshoot?
\item
  Progress report: PI will ask a selection of members for a progress report. In semester 1, these are typically to guide UG project students as they begin their projects.
\item
  OSF Review: We'll check whether any milestones have been reached lately
\item
  Research content (ordered by priority; we won't do all things every meeting): Lab members starting a new study will give their elevator speech and demo their program, lab members with new data will describe it for us (must have a graph!), we will discuss a relevant research paper
\end{enumerate}

\section{Upcoming dates and extra content}\label{upcoming-dates-and-extra-content}
...
Sub-groups of us shall sometimes meet for specific business that doesn't involve the whole lab. For instance, many lab members are students, and students may have contact hours with the PI related to their course that non-student lab members won't attend. The personnel involved in particular projects will convene \emph{Data Round-up Meetings}, in which we compile, anonymize, exclude ineligible participants from a data set, and securely back-up the data ahead of the analysis.

\section{Communication between meetings}\label{communication-between-meetings}
...
UGR project students similarly have a dedicated MS Team for communicating about their project work.

\chapter{Seminars at Cardiff University}\label{seminars-at-cardiff-university}
...
\item
  Cardiff's branch of the UK Reproducibility Network: Join the mailing list (\url{https://intranet.cardiff.ac.uk/staff/get-involved/groups-and-networks/view/reproducibility-network}) and watch for announcements. (Note -although my name is on this I'm no longer responsible for it and I have no idea whether the current staff running this are planning anything soon.)
\item
  Cognitive Development Group: some Thursday afternoons. If interested, request to join the CogDev group on Teams, currently managed by Rhys Davies (\href{mailto:daviesrm19@cardiff.ac.uk}{\nolinkurl{daviesrm19@cardiff.ac.uk}}).
\item
...
\chapter{Student projects we support at Cardiff University}\label{student-projects-we-support-at-cardiff-university}
...
The School of Psychology offers a few PhD student places every year, and in some years this lab explicitly seeks PhD candidates through this mechanism. We encourage applicants interested in working memory to apply even if the exact description of the project on offer doesn't sound quite like what you are after. Staff are required to post an idea for a project to enter the School's competition for PhD places, but Dr.~Morey would usually be willing to change the plan for a talented student who has a great idea. Students who love the project as described will also always be encouraged to augment it and make it their own.
...
\subsection{DEdPsy, Educational Psychology}\label{dedpsy-educational-psychology}
...
\subsection{Taught MSc student projects}\label{taught-msc-student-projects}

We are happy to host students taking part in the \textbf{Children's Psychological Disorders}, \textbf{MSc Psych}, and \textbf{Social Science Research} MSc degrees. Appropriate project suggestions will be available annually upon request. Feel free to get in touch with Candice Morey to discuss ideas.
...
Every year we host final year UG projects. A selection of project descriptions are available to all rising final year students every spring. Upon joining the lab, students receive an updated list of opportunities for projects. Note though that some projects require the participation of multiple student researchers. Choice of project is always a function of both logistic constraints (including the areas suitable for Dr.~Morey to supervise, given her expertise) and student preference.
...
\subsection{LTA and SPRINT summer research projects}\label{lta-and-sprint-summer-research-projects}
...
\subsection{Nuffield summer intern placements}\label{nuffield-summer-intern-placements}
...
\chapter{When a new researcher starts}\label{when-a-new-researcher-starts}
...
\section{Research Integrity Training}\label{research-integrity-training}
...
You can find the Research Integrity Training under \emph{Organsiations} in Learning Central.

\section{Information Security Training}\label{information-security-training}
...
You can find the Research Integrity Training under \emph{Organisations} in Learning Central.

\section{Location-specific training}\label{location-specific-training}
...
\subsection{Access to 64 Park Place 0.05}\label{access-to-64-park-place-0.05}

Request swipe-card access from the PI, who will forward your request to \href{mailto:psych-facilities@cardiff.ac.uk}{\nolinkurl{psych-facilities@cardiff.ac.uk}}.

\subsection{Security in 64 Park Place 0.05}\label{security-in-64-park-place-0.05}

64 Park Place is only accessible to personnel with swipe-card access. The Cardiff University Film Unit is based there, and some staff involved with Registry have their offices there. During regular working hours, there should always be people around to help in case of an emergency. Note the signs indicating fire escape routes and current first aiders.
...
\subsection{Booking 64 Park Place 0.05}\label{booking-64-park-place-0.05}
...
\url{https://www.cardiff.ac.uk/research/explore/research-units/centre-for-human-developmental-science}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/osf_fork.png}}
...
For the files you see on OSF, there should be some commonalities in how they are named. You will need to come up with a scheme for naming the files associated with your project. This should not be something too generic like ``dissertation consent form.doc'' or ``experiment 1'': if that were allowed we would have dozens of files with the same names. Pick a short name or acronym for your project that says something about what is unique about it. Then, use that short name to name your files. So, instead of ``consent form.pdf'' your file might be ``wmSpanPrefix\_consentForm.pdf''. Note also the use of the underscore: it is good practice never to include spaces in file names. Note also the initial word is lowercase and subsequent words are capitalized. This formatting is called \emph{camelCase}. We frequently have to type file names in contexts where the name must be reproduced exactly for code to run, so it is very helpful if you consistently apply camelCase to all your final names.

\subsection{Contributors}\label{contributors}

You can see who all the \emph{contributors} on a project are by clicking the \textbf{\emph{Contributors}} button on the upper ribbon. You may be able to add new contributors if you would like for someone else to be able to see your page. You can choose whether to let a new contributor only read your page or also edit your project page.
...
\section{Using your OSF project page to monitor progress}\label{using-your-osf-project-page-to-monitor-progress}
...
Your Preliminary Plans directory may also include work you did that informed your plan. For example, see the Preliminary Plans directory in \emph{A complex effect of memory load on processing speed}.

\subsection{Then you prepare your materials}\label{then-you-prepare-your-materials}
...
\subsection{Then you work on data analysis}\label{then-you-work-on-data-analysis}

Once you have stopped acquiring data, you should compile it into one file (or we may do this together in a \emph{Data Round-up Meeting}), anonymize it (more on that later), and upload it to the Data and Analysis Scripts directory. You can add analyses when you have finished them.

\subsection{Finally, you communicate your research}\label{finally-you-communicate-your-research}
...
Making a \emph{registration} creates a frozen, time-stamped version of your project. Registrations cannot be changed, while projects can. Someone could remove data from a project, but not from a registration. It makes sense to register your project at key moments where you might want a permanent record of what you thought before the next phase. Generally, we want to register a project:
...
A template consent form is available from the School of Psychology Research Ethics Committee, available in the Ethics section of \url{https://inside.psych.cf.ac.uk/}. (Note: InsidePsych is only available to interal users.) The main things that must always be included in the information form:
...
\section{Applying these principles in our lab}\label{applying-these-principles-in-our-lab}

Individual researchers will not typically need to acquire ethics approval independently. Most research projects will fall under one of our existing, approved generic \hyperref[ethics-approvals-currently-in-place]{headings}. Individual researchers will need to ensure that their experimental paperwork, data recording procedures, and protocol are all aligned with these principles:
...
\item
  Arbitrary \hyperref[assigning-participant-identifiers]{participant ids} are never associated with participant's signed consent form.
\item
  Any document that links personal ids with arbitrary ids must is treated as \textbf{confidential}. It cannot be accessible (in digital or print form) to anyone unnamed on the ethics application. It must be possible to destroy once the links are no longer needed. Once that destruction occurs, it must be truly impossible to re-forge the links. There cannot be a back-up way to reconstruct these links from any recorded data we preserve.
\item
  An appropriate education debriefing is prepared for every project. Sample debriefings are available in the shared lab OneDrive folder, in the \emph{templateForms} directory.
\end{enumerate}

\section{Assigning participant identifiers}\label{assigning-participant-identifiers}
...
\emph{Vignette:} An ambitious MSc project involved collecting data from participants in two sessions. Participants ran two sessions each, performing two of the four conditions in each session. Eventually though, all of these data needed to be analyzed together. (After all, that is the advantage of going to the effort to get the same data in each participant - you get to do a within-participant analysis.) The student ran each session with a unique identifier. This certainly prevented any data from being accidentally overwritten, but it meant that when it was time to analyze the data, we needed a way to code which ids were actually the same people. There is no elegant way to do this, because there was no regularity between the ids to exploit (coding requires regularity to exploit). Below is the code we used to assign new participant ids to both of the data sets from each participant.
...
\CommentTok{\# 1=29}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{1} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{29}\NormalTok{]}\OtherTok{=}\DecValTok{129}
\CommentTok{\# 2=19}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{2} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{19}\NormalTok{]}\OtherTok{=}\DecValTok{219}
\CommentTok{\# 3=16}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{3} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{16}\NormalTok{]}\OtherTok{=}\DecValTok{316}
\CommentTok{\# 4=25}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{4} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{25}\NormalTok{]}\OtherTok{=}\DecValTok{425}
\CommentTok{\# 5=32}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{5} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{32}\NormalTok{]}\OtherTok{=}\DecValTok{532}
\CommentTok{\# 6=13}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{6} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{13}\NormalTok{]}\OtherTok{=}\DecValTok{613}
\CommentTok{\# 7=14}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{7} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{14}\NormalTok{]}\OtherTok{=}\DecValTok{714}
\CommentTok{\# 8=24}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{8} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{24}\NormalTok{]}\OtherTok{=}\DecValTok{824}
\CommentTok{\# 9=15}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{9} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{15}\NormalTok{]}\OtherTok{=}\DecValTok{915}
\CommentTok{\# 10=17}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{10} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{17}\NormalTok{]}\OtherTok{=}\DecValTok{1017}
\CommentTok{\# 11=39}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{11} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{39}\NormalTok{]}\OtherTok{=}\DecValTok{1139}
\CommentTok{\# 18=23}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{18} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{23}\NormalTok{]}\OtherTok{=}\DecValTok{1823}
\CommentTok{\# 22=36}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{22} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{36}\NormalTok{]}\OtherTok{=}\DecValTok{2236}
\CommentTok{\# 26=49}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{26} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{49}\NormalTok{]}\OtherTok{=}\DecValTok{2649}
\CommentTok{\# 27=31}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{27} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{31}\NormalTok{]}\OtherTok{=}\DecValTok{2731}
\CommentTok{\# 28=60}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{28} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{60}\NormalTok{]}\OtherTok{=}\DecValTok{2860}
\CommentTok{\# 30=42}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{30} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{42}\NormalTok{]}\OtherTok{=}\DecValTok{3042}
\CommentTok{\# 33=54}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{33} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{54}\NormalTok{]}\OtherTok{=}\DecValTok{3354}
\CommentTok{\# 34=63}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{34} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{63}\NormalTok{]}\OtherTok{=}\DecValTok{3463}
\CommentTok{\# 35=40}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{35} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{40}\NormalTok{]}\OtherTok{=}\DecValTok{3540}
\CommentTok{\# 37=46}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{37} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{46}\NormalTok{]}\OtherTok{=}\DecValTok{3746}
\CommentTok{\# 38=48}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{38} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{48}\NormalTok{]}\OtherTok{=}\DecValTok{3848}
\CommentTok{\# 41=65}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{41} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{65}\NormalTok{]}\OtherTok{=}\DecValTok{4165}
\CommentTok{\# 43=59}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{43} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{59}\NormalTok{]}\OtherTok{=}\DecValTok{4359}
\CommentTok{\# 44=75}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{44} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{75}\NormalTok{]}\OtherTok{=}\DecValTok{4475}
\CommentTok{\# 45=52}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{45} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{52}\NormalTok{]}\OtherTok{=}\DecValTok{4552}
\CommentTok{\# 47=78}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{47} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{78}\NormalTok{]}\OtherTok{=}\DecValTok{4778}
\CommentTok{\# 50=57}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{50} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{57}\NormalTok{]}\OtherTok{=}\DecValTok{5057}
\CommentTok{\# 51=69}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{51} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{69}\NormalTok{]}\OtherTok{=}\DecValTok{5169}
\CommentTok{\# 53=55}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{53} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{55}\NormalTok{]}\OtherTok{=}\DecValTok{5355}
\CommentTok{\# 56=66}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{56} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{66}\NormalTok{]}\OtherTok{=}\DecValTok{5666}
\CommentTok{\# 58=67}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{58} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{67}\NormalTok{]}\OtherTok{=}\DecValTok{5867}
\CommentTok{\# 61=64}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{61} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{64}\NormalTok{]}\OtherTok{=}\DecValTok{6164}
\CommentTok{\# 62=71}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{62} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{71}\NormalTok{]}\OtherTok{=}\DecValTok{6271}
\CommentTok{\# 68=74}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{68} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{74}\NormalTok{]}\OtherTok{=}\DecValTok{6874}
\CommentTok{\# 70=72}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{70} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{72}\NormalTok{]}\OtherTok{=}\DecValTok{7072}
\CommentTok{\# 73=76}
\NormalTok{d}\SpecialCharTok{$}\NormalTok{Subject[d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{73} \SpecialCharTok{|}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{Subject}\SpecialCharTok{==}\DecValTok{76}\NormalTok{]}\OtherTok{=}\DecValTok{7376}
\end{Highlighting}
\end{Shaded}
...
\section{Ethics approvals currently in place}\label{ethics-approvals-currently-in-place}

\subsection{Limits of memory (EC.17.09.12.4952G)}\label{limits-of-memory-ec.17.09.12.4952g}
...
\subsection{Memory storage and processing across the lifespan (EC.18.09.185339GR)}\label{memory-storage-and-processing-across-the-lifespan-ec.18.09.185339gr}
...
\subsection{Incidental memory (EC.23.05.16.6803GR)}\label{incidental-memory-ec.23.05.16.6803gr}
...
\subsection{Working memory limits (EC.24.09.10.7051G)}\label{working-memory-limits-ec.24.09.10.7051g}
...
\chapter{Ethics at Cardiff School of Psychology}\label{ethics-at-cardiff-school-of-psychology}
...
\section{How to apply for ethical review?}\label{how-to-apply-for-ethical-review}

A great starting point for information and resources about the ethical review process can be found at \href{https://inside.psych.cf.ac.uk/}{InsidePsych}. Log in with your Cardiff University credentials and navigate to the \emph{\textbf{Ethics}} tab which can be found in the Undergraduate, Postgraduate, and Staff pages.

\section{Mandatory Research Integrity Training}\label{mandatory-research-integrity-training}

All researchers must complete the Cardiff University Research Integrity Training module. PGRs and staff members should automatically find this as an enrollment on their Learning Central page. UGRs can access it \href{https://intranet.cardiff.ac.uk/staff/training-and-development/staff-courses-and-programmes/research-careers/training/research-integrity-online-training-programme}{here}.

\subsection{Types of applications}\label{types-of-applications}

All applications and supporting documents must be emailed to the Ethics committee at \href{mailto:psychethics@cardiff.ac.uk}{\nolinkurl{psychethics@cardiff.ac.uk}}

\textbf{1. Proportionate applications:} This procedure is used for proposals that do not raise any ethical issues and recruits participants from the School's participant panel. To recruit from the panel, you will need to sign up for a researcher account on the School of Psychology's \href{https://cardiff.sona-systems.com/Default.aspx?ReturnUrl=/}{Experimental Management System} and obtain ethical approval before you begin recruiting participants. Proportionate applications can also be used to make minor amendments to a project that has been previously approved. These applications must be submitted by midday on a Friday and a decision will be made within 7-10 days.

\textbf{2. Full applications:} These applications require more detailed descriptions of the experimental procedures, research design, and ethical considerations. Full applications must be submitted at least two weeks before the Ethics Committee's next meeting. The committee usually meets on the first Tuesday of every month.
...
All lab personnel should complete the \href{https://intranet.cardiff.ac.uk/staff/news/view/211993-information-security-training-when-will-you-complete-yours}{web-based Data Security training module} offered by Cardiff University.
...
This is obviously ridiculous, but technically possible. It is referred to as the \emph{motivated intruder test}, and we cannot consider our data truly anonymous if a motivated intruder could easily uncover and exploit the indirect links between anonymous data and identifiable information we may have access to. To comply with EU privacy regulations, we need to take steps to protect participant identities even when we think our data are harmless. This holds regardless of whether we plan to make the anonymous data set publicly available. Unless you are storing the data only on secured Cardiff University resources, it must be properly anonymized. This means that before we anonymize it, data cannot be held even temporarily on personal disks, on DropBox, or Google Docs, and cannot be emailed to non-university email addresses.
...
All lab personnel will be given access to a OneDrive folder ``labBackUp\_cmorey''. While data collection is ongoing, the researcher responsible for data collection should add newly acquired data to the OneDrive lab back-up every day new data are acquired. There are sub-directories in \emph{labBackUp\_cmorey} for all the physical spaces we use to collect data. Simply copy the your experiment directory on the physical machine to the corresponding sub-directory in \emph{labBackUp\_cmorey}.
...
These data are \emph{confidential} because they include timestamps that, if linked to the participant's EMS schedule or to information the participant discloses publicly about their participation in experiments, their identity could be reconstructed. You should not save these data onto portable drives - they are not secure enough. They should be saved only on the \emph{labBackUp\_cmorey} OneDrive, to the lab computers which sit in a secured location, or to password-protected computers associated with Cardiff University.

\subsection{When data collection is closed}\label{when-data-collection-is-closed}

Once we have decided not to collect any more data on a project, it is time to compile and anonymize that data set. This should always occur before any analyses are attempted, and must always be done in a scripted fashion. For lab members not fluent in scripting, this should be done in a face-to-face meeting with the PI or another senior lab member. This is the \textbf{Data Round-up Meeting}.

\subsection{Cleaning up lab directories}\label{cleaning-up-lab-directories}

After we have compiled the data, created anonymized versions, and backed up the original data to Dr.~Morey's H drive, it should not matter whether the original data files stored on \emph{labBackUp\_cmorey} or on local machines are lost. These sources are sufficiently secure for our data, which are at most \emph{confidential}, never \emph{highly confidential}. In the event that we collect \emph{highly confidential} data, such data should be deleted from local machines and OneDrive as soon as we have the compiled data backed up to the more secure H drive. For data that is \emph{confidential} we need not rush to delete it. We shall allow most data to exist on \emph{labBackUp\_cmorey} until the space is required for newer data, and then delete the oldest files that have been compiled and backed up first. The researcher responsible for the data should delete it from the local machine where it was collected after data round-up for that project is finished.
...
Paper data should also exclude personally identifiable information. It will also be considered \emph{confidential} because some combination of lab personnel could work out the identity of the participant by linking the participant id on the paperwork with corresponding digial data with a timestamp. This is why paper data should remain in the secure lab. Once scanned, the digital file shall be saved to the appropriate OneDrive directory and to Dr.~Morey's H drive.
...
Our ethics approval states that we shall destroy this key when data collection is finished. For projects involving a key, key destruction will be the last item on the agenda of the \textbf{Data Round-up Meeting}. Once we have compiled and written the anonymous data files, we shall run tests to be sure that we have correctly matched up participant ids across sessions. Once satisfied of this, we shall delete all copies of the key.
...
\section{Use computers whenever possible to control stimulus presentation and response collection}\label{use-computers-whenever-possible-to-control-stimulus-presentation-and-response-collection}
...
\subsection{\texorpdfstring{It's more work in the end \emph{not} to automate}{It's more work in the end not to automate}}\label{its-more-work-in-the-end-not-to-automate}
...
There will sometimes be projects for which we don't follow these principles. Sometimes, we will have a good reason for wanting participants to give natural, vocal responses, which currently cannot be evaluated in real-time by a computer. There are bound to be other exceptions. Expedience is \textbf{not} a good reason though. If you have no idea how to implement something, ask for the support of the group.

\chapter{Should I run my study online?}\label{should-i-run-my-study-online}
...
\section{Key questions to ask yourself}\label{key-questions-to-ask-yourself}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  In my paradigm, are there plausible checks I can build in to ensure that participants engage with my task? Options include a practice session with feedback, or possibly requiring a minimum level of accuracy before a participant can proceed past practice.
\item
  Will I be able to tell the difference between an engaged participant and a random responder? Are there checks I can include to test for random responding?
\end{enumerate}

See this useful advice from Prof.~Jenni Rodd about \href{https://www.psychologicalscience.org/observer/how-to-maintain-data-quality-when-you-cant-see-your-participants\#.XHzv5ldcHCF.twitter}{ensuring data quality when running participants online}.

If you cannot be sure about your data's quality if you run online, then you should plan to run in the lab.

\chapter{Running studies online}\label{running-studies-online}
...
We can recruit paid participants via Prolific (which we prefer to other options for running studies online; see Uittenhove et al.'s paper about \href{https://www.journalofcognition.org/articles/10.5334/joc.259/}{this}).
...
\section{Automated communication between server and participant recruitment platform}\label{automated-communication-between-server-and-participant-recruitment-platform}

You need to allow for your experimental program to collect a static participant id from your recruitment platform, and also to send the participant back to their recruitment platform for completion to be acknowledged. This magic happens via the URLs provided. There is advice about this for specific platforms (see, e.g., \url{https://inside.psych.cf.ac.uk/} sections on EMS and Qualtrics for advice from School of Psychology). The experiment URL will be something like \url{https://jatos.mindprobe.eu/publix/0000} or \url{https://run.pavlovia.org/UserName/experimentName}. To these, you would need to append ?PROLIFIC\_PID=\{\{\%PROLIFIC\_ID\%\}\} to log a Prolific Id or ?SONA\_ID=\%SURVEY\_CODE\% to log an EMS id.

\section{PsychoPy Builder to Pavlovia}\label{psychopy-builder-to-pavlovia}
...
\section{Anecdote: Instructions for transporting a paradigm from Open Sesame to MindProbe, and recruiting via Prolific}\label{anecdote-instructions-for-transporting-a-paradigm-from-open-sesame-to-mindprobe-and-recruiting-via-prolific}
...
\subsection{Step 3: Generating a study link}\label{step-3-generating-a-study-link}
...
\url{https://v2.jatos.org/Worker-Types.html\#-mturk-sandbox-worker}.

Once the link is generated copy and paste it somewhere you can easily find it. You will need it to recruit participants.

\subsection{Step 4: Begin setting up the experiment on Prolific}\label{step-4-begin-setting-up-the-experiment-on-prolific}
...
\subsection{Step 5: Recording Prolific Ids}\label{step-5-recording-prolific-ids}
...
\subsection{Step 6: Generating a completion URL}\label{step-6-generating-a-completion-url}
...
\subsection{Step 7: Finish setting up the study on Prolific}\label{step-7-finish-setting-up-the-study-on-prolific}
...
\subsection{Step 8: Publish the experiment to Prolific}\label{step-8-publish-the-experiment-to-prolific}
...
\subsection{Step 9: Downloading your data from Mindprobe}\label{step-9-downloading-your-data-from-mindprobe}
...
\subsection{Step 10: Transforming data to .csv file}\label{step-10-transforming-data-to-.csv-file}
...
\subsection{Step 11: Granting participant payments}\label{step-11-granting-participant-payments}
...
\url{https://researcher-help.prolific.co/hc/en-gb/articles/360009092394-Approvals-rejections-returns}.
...
(Note, we would \textbf{never} actually do that. Of course non-lab members cannot do our lab work - see data security. But nonetheless your protocol should be detailed enough to allow it.)
...
Your protocol should start with whatever must be done \emph{before} the first participant arrives. As a general rule, set-up should be complete 10 minutes before the participant is expected. Assume this, and work backwards for determining how early setting up the lab for your procedure must begin.
...
Do not plan to have your participants read through instructions on their own. Of course they \emph{can} read, but always keep in mind that many participants want to get in and out of the lab as quickly as possible. They will assume that they can just figure it out, and click through instructions like it's their iPhone legal agreement update. They will get to a trial, and call you over because they do not know when to respond or what button to press.
...
\subsection{Exceptions and unsual events}\label{exceptions-and-unsual-events}
...
\section{Adults from the university community}\label{adults-from-the-university-community}

\subsection{Experiment Management System (EMS)}\label{experiment-management-system-ems}
...
\subsection{Access to EMS}\label{access-to-ems}

The first thing to do is to obtain a researcher account from the EMS team. This can be done by emailing \href{mailto:psychems@cardiff.ac.uk}{\nolinkurl{psychems@cardiff.ac.uk}}. Just let them know that you are a researcher, working with Dr Candice Morey, and you need an account to post an experiment and shortly they will send you an email with your credentials.
...
\subsection{Administering an experiment on EMS}\label{administering-an-experiment-on-ems}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/images/participantViewEMS.png}}
...
\subsection{Alternatives to EMS}\label{alternatives-to-ems}
...
\subsection{How to recruit via schools}\label{how-to-recruit-via-schools}
...
\subsection{How to recruit via the CUCHDS database for on-campus testing}\label{how-to-recruit-via-the-cuchds-database-for-on-campus-testing}
...
In order to give back to the CUCHDS research community, it is good practice when recruiting families from outside of the CUCHDS database to encourage families who are interested in taking part in more research studies to fill in the database registration form (\url{https://tinyurl.com/T2TDatabase}). This link can be added to emails, captions of recruitment posts on social media, recruitment fliers, etc. It can also be used to generate a QR code if you are adding the link to paper documents/fliers so that parents can scan the QR code and be sent straight to the sign-up link.
...
\subsection{Recruiting via social media}\label{recruiting-via-social-media}
...
The \emph{Participate in research} Yammer channel may also yield some recruits. It is monitored by a lot of university staff, who actively participate themselves and might be open to bringing their family in for research opporuntities.

\chapter{Dealing with the unexpected during data collection}\label{dealing-with-the-unexpected-during-data-collection}
...
\section{Sleepy, sick, or inebriated participants}\label{sleepy-sick-or-inebriated-participants}
...
\section{The participant with a lot of questions}\label{the-participant-with-a-lot-of-questions}
...
\chapter{Tips and tricks for working with children}\label{tips-and-tricks-for-working-with-children}
...
\section{Designing an experiment for children}\label{designing-an-experiment-for-children}
...
\section{On the day considerations}\label{on-the-day-considerations}
...
\chapter{Organizing your research data}\label{organizing-your-research-data}
...
\subsection{Preparing for the Data Round-up Meeting}\label{preparing-for-the-data-round-up-meeting}
...
\tightlist
\item
  Gather all paperwork participants completed and bring it to the meeting. If any data was recorded on paper, there should be instructions for putting it into a digital format. This should also be done ahead of the meeting.
\item
  Scan all consent forms and send the .pdfs to the PI.
\item
  Make sure all the data you collected or coded is saved to its designated directory on \emph{labBackUp\_cmorey}.
\item
  If you are analyzing data in software other than R, think about what output you need from the raw data set, and what form it should take.
\end{enumerate}

All of these actions must be finished before we can begin.

\subsection{Pull all the data together}\label{pull-all-the-data-together}

First, the team shall compile the data associated with the project from the \emph{labBackUp\_cmorey} folder. It is essential that this folder is up-to-date ahead of the meeting - data collectors, please ensure that you have copied all data to the back-up ahead of time.

At the meeting, we will use this code to compile each individual backed-up data file into a single data frame, called \emph{d} in this example:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d }\OtherTok{=} \FunctionTok{map\_df}\NormalTok{(}\FunctionTok{list.files}\NormalTok{(}\AttributeTok{path =} \StringTok{""}\NormalTok{, }\AttributeTok{full.names =} \ConstantTok{TRUE}\NormalTok{), }
\NormalTok{                 read\_csv, }\AttributeTok{col\_names =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}

This code creates a dataframe called \emph{d} that includes all the .csv files in the project directory, which will be entered into the \emph{path} argument.

\subsection{Anonymization}\label{anonymization}

We shall then examine \emph{d}'s headings for information that could identify the participant. Anything that has to do with the date and time of the session must be omitted. Recorded birthdates must be omitted. Usually, we would not have recorded anything more personal than that, but if so, it must be omitted at this stage.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{unique}\NormalTok{(d}\SpecialCharTok{$}\NormalTok{YoB)}
\end{Highlighting}
\end{Shaded}
...
If we recorded \emph{Year of Birth}, we can now create a new variable converting birth year to age at the time of the study. For most purposes, this does not need to be very precise. We can do this with a simple \emph{mutate}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d }\OtherTok{=}\NormalTok{ d }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{age =} \DecValTok{2018} \SpecialCharTok{{-}}\NormalTok{ YoB) }\CommentTok{\# current year {-} column name containing the birth year}
\end{Highlighting}
\end{Shaded}

If we recorded the full birthdate, we probably need age in more precision. The R package \emph{lubridate} is useful for sorting out birthdates and calculating precise ages from birthdates and run dates.

Once we have created whatever new, anonymous variables we need from the potentially identifying data, we can create a new data set with the identifiable data omitted. We would do that with script like this, using the \emph{select} function:
...
\NormalTok{symsp }\OtherTok{=}\NormalTok{ symsp }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\FunctionTok{c}\NormalTok{(Clock.Information, Email, SessionDate, SessionTime)) }\CommentTok{\# The "{-}" negates the select, meaning that everything *except* the named columns remain.}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# The participants we are excluding based on inability to label one or more pictures: 007, 015, 018, 044}

\CommentTok{\# Checking your lab\textquotesingle{}s log or notes, describe any participant number who should be excluded based on those notes here.}
\CommentTok{\# 37 was videoed but mouth was not visible (and there was no coder in real{-}time)}
\CommentTok{\# 54: program malfunction}
\CommentTok{\# 061: experimenter (CCM) accidentally modelled speech rehearsal during practice}
\CommentTok{\# 095, 96, 97 were siblings or friends who were run, but not members of the intended age groups. These participants do not need to be counted as "excluded" for the exclusions in Table B, because they were not sampled according to our plan.}
\CommentTok{\# Q: Actually 96 is 6 years{-}old {-} can we include, or was there another problem? A: There is ambiguity about 96\textquotesingle{}s age. Value in lab js and log are different. Experimenter is sure that the offline recording of 96\textquotesingle{}s age is the correct one.}

\CommentTok{\# Put all the participant ids who are to be excluded inside this list}
\NormalTok{exSubs }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\StringTok{"37"}\NormalTok{, }\StringTok{"007"}\NormalTok{, }\StringTok{"015"}\NormalTok{, }\StringTok{"018"}\NormalTok{, }\StringTok{"044"}\NormalTok{, }\StringTok{"54"}\NormalTok{,}\StringTok{"061"}\NormalTok{, }\StringTok{"095"}\NormalTok{, }\StringTok{"96"}\NormalTok{, }\StringTok{"97"}\NormalTok{)}

\NormalTok{d }\OtherTok{=}\NormalTok{ d }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(}\SpecialCharTok{!}\NormalTok{(participant\_id}\SpecialCharTok{\%in\%}\NormalTok{(exSubs)))}

\CommentTok{\# Note excluded participants ages for inclusion in Table B}
\CommentTok{\# 007 {-} 5 years}
\CommentTok{\# 015 {-} 6 years}
\CommentTok{\# 018 {-} 6 years}
\CommentTok{\# 044 {-} 6 years}
\CommentTok{\# 54 {-} 5 years}
\CommentTok{\# 061 {-} 6 years}
\CommentTok{\# 37 {-} 6 years}
\CommentTok{\# Totals:}
\CommentTok{\# 5 years: 2}
\CommentTok{\# 6 years: 5}
\end{Highlighting}
\end{Shaded}

The object \emph{exSubs} lists each participant id to be omitted. It is important that this list reflects how the data were recorded. We should check at this point whether the participant ids were recorded as characters (and should therefore be inside ``\,``s) or as numbers (no quotes). When they are characters, we should confirm that each participant id is unique and always recorded with the exact same character string (and that that character string is the one we put in exSubs).

The \emph{filter} function performed on data frame data instructs R to keep all rows where the participant id does not match one from the exSubs list.
...
\subsection{Milestone: Data posted on OSF}\label{milestone-data-posted-on-osf}
...
Uittenhove, K., Jeanneret, S., \& Vergauwe, E. (2023). From Lab-Testing to Web-Testing in Cognitive Research: Who You Test is More Important than how You Test. Journal of Cognition, 6(1), Article 1. \url{https://doi.org/10.5334/joc.259}
