...
During the 2019-2020 academic terms, we will meet alternating Tuesdays, 13:30-15:00, 7.10 Tower (unless otherwise noted), beginning 12 November.
...
I also mention here some scheduled meetings with other subsets of members that I think could be of more general interest.

Tuesday 12 November: Candice will present the main outcomes of the British Academy-funded project investigating whether a single construct supports remembering during complex working memory span tasks.

Tuesday 26 November: (unless something else arises?) Candice will present a summary of effects of memory load on processing judgments, plus we can have a first look at the data that Kelsey has been collecting.

Monday 9 December: Mainly for UG project students (but anyone is welcome), we are discussing academic writing, mainly how to improve it. Reading to be discussed: Steven Pinker's Why Academic Writing Stinks (pdf on Slack, #fyprojects)

Tuesday 10 December: TBA
