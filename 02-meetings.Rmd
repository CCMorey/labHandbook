...
2. Progress report: PI will ask a selection of members for a progress report
...
We also need a regular moment to mark the interim successes that occur during research projects that don't merit wide attention. Finishing a pilot-testing, submitting a conference presentation, finding something interesting in an analysis are all moments that call for some celebration, but will only be interesting to like-minded geeks. 
